...
function guikit:internal/summon_resolve with storage guikit:ctx
execute unless data storage guikit:ctx cdef run function guikit:internal/summon_legacy with storage guikit:ctx
...
execute if data storage guikit:ctx cdef.title run function guikit:internal/summon_titled with storage guikit:ctx cdef
execute unless data storage guikit:ctx cdef.title run function guikit:internal/summon_type with storage guikit:ctx cdef
...
function guikit:internal/cont_bind with storage guikit:ctx
