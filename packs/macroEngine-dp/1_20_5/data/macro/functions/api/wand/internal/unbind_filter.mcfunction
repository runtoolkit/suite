# macro:api/wand/internal/unbind_filter
...
function macro:api/wand/internal/unbind_check with storage macro:engine _wand_cur

function macro:api/wand/internal/unbind_filter
