# macro:api/wand/internal/check_next
...
function macro:api/wand/internal/check_item with storage macro:engine _wand_current

function macro:api/wand/internal/check_next
