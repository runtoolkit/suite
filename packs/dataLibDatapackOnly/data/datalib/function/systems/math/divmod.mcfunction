...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"math/divmod ","color":"aqua"},{"text":"($(value)/$(divisor))","color":"gray"},{"text":" → ","color":"#555555"},{"text":"q=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"quotient","color":"green"},{"text":" r=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"remainder","color":"green"}]
