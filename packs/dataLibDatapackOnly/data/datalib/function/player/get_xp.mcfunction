...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"player/get_xp ","color":"aqua"},{"text":"$(player) → level=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"level","color":"green"},{"text":" pts=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"points","color":"green"}]