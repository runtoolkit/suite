execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v5.1.0"}
data modify storage macro:engine global.version set value "v5.1.0"
