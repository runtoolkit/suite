...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"player/get_food ","color":"aqua"},{"text":"$(player) → food=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"food","color":"green"},{"text":" sat=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"saturation","color":"green"}]