# macroengine_load:gate/toggle/disable
...
function macroengine_load:gate/request {type:"gate_bypass",label:"Disable gate confirmations (dangerous commands will run immediately)",action:"macroengine:core/internal/gate/toggle/disable_apply",args:{}}
