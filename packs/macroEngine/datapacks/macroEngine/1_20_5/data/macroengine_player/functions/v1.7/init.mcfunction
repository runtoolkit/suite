...
schedule function macroengine_player:v1.7/tick 5t
schedule function macroengine_player:v1.7/player/click_detection/tick_entities 100t
data merge storage macroengine_player:temp {list:[], obj:{}, var:""}
