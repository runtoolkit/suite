...
execute if data storage datalib:engine schedules run tellraw @a[tag=datalib.debug] ["",{"text":" ","color":"#555555"},{"plain":true ,"storage":"datalib:engine","nbt":"schedules","interpret":false,"color":"gold"}]
