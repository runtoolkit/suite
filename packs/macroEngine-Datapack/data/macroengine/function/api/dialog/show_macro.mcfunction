# macroengine:api/dialog/show_macro
# Shows a dialog from inline JSON stored in macroengine:engine dialog.DATA.
...
#   data modify storage macroengine:engine dialog.DATA set value '{...}'
#   function macroengine:api/dialog/show_macro
#
# BUGFIX v6.0.1: this file was missing from the base overlay entirely.
# Without it, any pack calling macroengine:api/dialog/show_macro on 1.20.3–1.21.5
