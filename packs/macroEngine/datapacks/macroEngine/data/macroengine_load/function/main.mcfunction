# macroengine_load:main — load entry
...
# force-reload path (macroengine_load:load/force) is gated when sandbox:1b —
# clicking the link below opens a confirm/cancel prompt instead of
# force-reiniting immediately. See macroengine_load:gate/request.
