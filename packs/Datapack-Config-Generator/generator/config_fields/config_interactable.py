...
class Toggle(ConfigField):
    ...
    def render(self, indent=0):
        ...
        return ("""\n# %(label)s"""
                + """\nexecute unless score %(sb)s > #zero constants run tellraw @s ["%(indent)s",{"text":"☒","color":"red","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)senable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to enable ","color":"green"},"%(label)s"]}},"%(label)s"]"""
                + """\nexecute if score %(sb)s > #zero constants run tellraw @s ["%(indent)s",{"text":"☑","color":"green","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdisable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"%(label)s"]}},"%(label)s"]"""
                + "\n") % self.args
...
class Adjustable(ConfigField):
    ...
    def render(self, indent=0):
        ...
        if self.args["min_sb"]:
            ...
            end += """\nexecute unless score %(adjust_pl)s %(adjust_sb)s > %(min_sb)s """ + ("if score %(adjust_pl)s %(adjust_sb)s < %(max_sb)s " if self.args["max_sb"] else "") + """run tellraw @s ["%(indent)s",{"text":"☐","color":"gray","bold":true},"%(label)s ", {"text":"-","color":"gray","hover_event":{"action":"show_text","value":["",{"text":"Cannot decrease further"}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"green","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sinc/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to increase %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}]"""
        ...
        if self.args["max_sb"]:
            ...
            end += """\nexecute unless score %(adjust_pl)s %(adjust_sb)s < %(max_sb)s """ + ("if score %(adjust_pl)s %(adjust_sb)s > %(min_sb)s " if self.args["min_sb"] else "") + """run tellraw @s ["%(indent)s",{"text":"☐","color":"gray","bold":true},"%(label)s ", {"text":"-","color":"red","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdec/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to decrease %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"gray","hover_event":{"action":"show_text","value":["",{"text":"Cannot increase further"}]}}]"""

        # Basic call with toggle, inserts min and max filter if appropriate
        return ("""# %(label)s"""
                + """\nexecute%(filters)srun tellraw @s ["%(indent)s",{"text":"☐","color":"gray","bold":true},"%(label)s ", {"text":"-","color":"red","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdec/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to decrease %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"green","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sinc/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to increase %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}]"""
                + end + "\n") % self.args
...
class AdjustToggle(ConfigField):
    ...
    def render(self, indent=0):
        ...
        if self.args["min_sb"]:
            ...
            end += """\nexecute if score %(sb)s > #zero constants unless score %(adjust)s > %(min_sb)s """ + ("if score %(adjust)s < %(max_sb)s " if self.args["max_sb"] else "") + """run tellraw @s ["%(indent)s",{"text":"☑","color":"green","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdisable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"%(label)s"]}},"%(label)s ", {"text":"-","color":"gray","hover_event":{"action":"show_text","value":["",{"text":"Cannot decrease further"}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"green","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sinc/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to increase %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}]"""

        # If max_sb set, add check to basic call and add line for at max
        if self.args["max_sb"]:
            self.args["filters"] += "if score %(adjust)s < %(max_sb)s " % self.args
            end += """\nexecute if score %(sb)s > #zero constants unless score %(adjust)s < %(max_sb)s """ + ("if score %(adjust)s > %(min_sb)s " if self.args["min_sb"] else "") + """run tellraw @s ["%(indent)s",{"text":"☑","color":"green","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdisable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"%(label)s"]}},"%(label)s ", {"text":"-","color":"red","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdec/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to decrease %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"gray","hover_event":{"action":"show_text","value":["",{"text":"Cannot increase further"}]}}]"""

        # Basic call with toggle, inserts min and max filter if appropriate
        return ("""# %(label)s"""
                + """\nexecute unless score %(sb)s > #zero constants run tellraw @s ["%(indent)s",{"text":"☒","color":"red","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)senable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to enable ","color":"green"},"%(label)s"]}},"%(label)s"]"""
                + """\nexecute if score %(sb)s > #zero constants%(filters)srun tellraw @s ["%(indent)s",{"text":"☑","color":"green","bold":true,"click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdisable/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to disable ","color":"red"},"%(label)s"]}},"%(label)s ", {"text":"-","color":"red","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sdec/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to decrease %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}, " ", {"score":{"name":"%(adjust_pl)s","objective":"%(adjust_sb)s"}}, " ", {"text":"+","color":"green","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)sinc/%(function)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to increase %(label)s by "},{"score":{"name":"%(inc_pl)s","objective":"%(inc_sb)s"}}]}}]"""
                + end + "\n") % self.args
...
class Select(ConfigField):
    ...
    def render(self, indent=0):
        ...
        selects = [""", " ", {"text":"[ %(ch_label)s ]","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)ssel/%(ch_func_name)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to set %(label)s to %(ch_label)s "}]}}""" % c.args for c in self.choices]
        ...
        for i, choice in enumerate(self.choices):
            ...
            commands += ("""\nexecute if score %(sb)s matches %(ch_value)s run tellraw @s ["%(indent)s", {"text":"☐","color":"gray","bold":true}, "%(label)s" """ +
                            ("".join(selects[:i])) + 
                            """, " ", {"text":"[ %(ch_label)s ]","color":"green","click_event":{"action":"run_command","command":"/function %(namespace)s:config/%(directory)ssel/%(ch_func_name)s"},"hover_event":{"action":"show_text","value":["",{"text":"Click to set %(label)s to %(ch_label)s "}]}}""" + 
