...
execute store result score #StringLib.CheckString.CharsLeft StringLib run data get storage macroengine_string:temp data.String
...
data modify storage macroengine_string:temp data.CheckString.String set string storage macroengine_string:temp data.String 0 -1
data modify storage macroengine_string:temp data.CheckString.Find set string storage macroengine_string:input replace.Find 0 -1
