# macro:core/lib/fiber/internal/yield_exec [MACRO]
...
$data modify storage macro:engine queue append value {func:"macro:core/lib/fiber/internal/resume_dispatch", delay:$(delay)}
