...
# cache position
data modify storage macroengine_player:temp list set from entity @s Pos

# calc difference
execute store result score #x player_action.data run data get storage macroengine_player:temp list[0] 70
...
execute store result score #y player_action.data run data get storage macroengine_player:temp list[1] 70
...
execute store result score #z player_action.data run data get storage macroengine_player:temp list[2] 70
