...
execute store result storage macroengine:output daytime int 1 run time of minecraft:overworld query day
execute store result storage macroengine:output total int 1 run time query gametime
execute store result storage macroengine:output day int 1 run time of minecraft:overworld query day repetition
