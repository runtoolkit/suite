# macro:api/cmd/other/multi_cmd/internal/cond_tag_simple
...
function macro:api/cmd/other/multi_cmd/internal/cond_tag_exec with storage macro:engine _mcmd_cond_tmp
