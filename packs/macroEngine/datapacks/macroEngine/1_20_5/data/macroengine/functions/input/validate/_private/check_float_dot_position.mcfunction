...
# ======================================================================================
# macroengine_string:output find holds a one-element list [idx] for the '.' just
...
execute store result score #macroengine.DotIdx macroengine.tmp run data get storage macroengine_string:output find[0]
