...
IGNORE_PATHS=(
    ...
    "packs/macroEngine-Datapack-v26.2/data/macroengine/function/world/get_time.mcfunction"
    "packs/macroEngine-Datapack-v26.2/data/macroengine/function/world/time_phase.mcfunction"
)
