...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"player/get_health ","color":"aqua"},{"text":"$(player) → ","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"result","color":"green"},{"text":"/","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"max","color":"yellow"}]