...
summon minecraft:chest_minecart ~ ~ ~ {Invulnerable:1b,NoGravity:1b,Silent:1b,Tags:["guigen.menu","guigen.test_menu"]}
...
tellraw @s [{"text":"[GUI-GENERATOR] ","color":"gray"},{"text":"Menu opened. SHIFT-click buttons.","color":"yellow"}]
