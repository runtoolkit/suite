...
$execute if data storage datalib:engine permissions.$(player) run tellraw @a[tag=datalib.debug] ["",{"text":" ","color":"#555555"},{"plain":true ,"storage":"datalib:engine","nbt":"permissions.$(player)","interpret":false,"color":"yellow"}]
