...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"lib/ticks_to_time ","color":"aqua"},{"text":"($(ticks)t)","color":"gray"},{"text":" → ","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"hours","color":"green"},{"text":"h ","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"minutes","color":"green"},{"text":"m ","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"seconds","color":"green"},{"text":"s ","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"ticks","color":"green"},{"text":"t","color":"gray"}]
