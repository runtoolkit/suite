...
data modify storage macroengine_string:temp data.CheckString.String set string storage macroengine_string:temp data.String 1
data modify storage macroengine_string:temp data.CheckString.Find set string storage macroengine_string:input replace.Find 1
