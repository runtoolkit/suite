...
data remove storage macroengine_string:zprivate data
...
data remove storage macroengine_string:input insert
...
data remove storage macroengine_string:output to_number
data remove storage macroengine_string:output to_string
data remove storage macroengine_string:output find
data remove storage macroengine_string:output replace
data remove storage macroengine_string:output insert
