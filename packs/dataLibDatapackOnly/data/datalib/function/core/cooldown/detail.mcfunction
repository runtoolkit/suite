...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"cooldown/detail ","color":"aqua"},{"text":"$(player)","color":"white"},{"text":" → ","color":"#555555"},{"text":"$(key)","color":"aqua"},{"text":" active=","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"active","color":"green"},{"text":" rem=","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"remaining","color":"green"},{"text":" exp=","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"expires","color":"green"}]
