...
execute if data storage macroengine:engine {sandbox:1b} run return run function macroengine_load:gate/request {type:"load_force",label:"Force reload macroengine (discards live engine state)",action:"macroengine:core/internal/load/force_apply",args:{}}
