# macro:systems/rate_limit/internal/prune — Remove hits outside the sliding window [MACRO]
...
function macro:systems/rate_limit/internal/prune with storage macro:rl_work
