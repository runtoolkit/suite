...
#
# CALL WITH:
#   function datalib:input/validate/check with storage <yourpath> {source: "<path.to.field>", type: "int"|"float"|"bool"|"tag_safe"}
#
...
#                     stringlib:util/to_number AFTER checking result.valid —
...
# calls stringlib:util/find (read-only string search) against it.
# ======================================================================================
...
execute if data storage datalib:input_validate {scratch:{type:"int"}} run function datalib:input/validate/_private/check_int
execute if data storage datalib:input_validate {scratch:{type:"float"}} run function datalib:input/validate/_private/check_float
execute if data storage datalib:input_validate {scratch:{type:"bool"}} run function datalib:input/validate/_private/check_bool
execute if data storage datalib:input_validate {scratch:{type:"tag_safe"}} run function datalib:input/validate/_private/check_tag_safe
