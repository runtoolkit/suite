...
##         Example: "ABC" => "abc"                                                                      ##
##                                                                                                      ##
## The output is found in the 'macroengine_string:output to_lowercase' data storage                              ##
##########################################################################################################
...
data modify storage macroengine_string:output to_lowercase set from storage macroengine_string:output concat
