...
execute if data storage datalib:engine states run tellraw @a[tag=datalib.debug] ["",{"text":" ","color":"#555555"},{"plain":true ,"storage":"datalib:engine","nbt":"states","interpret":false,"color":"white"}]
