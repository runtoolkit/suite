# Module toggle guard — skips this module when disabled via macro:api/toggle/perm/false
execute unless data storage macro:engine {modules:{perm:1b}} run return 0
...
function macro:api/perm/trigger/internal/tick_step_loop
